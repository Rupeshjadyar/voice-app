...
<style>
  ...
  *,*::before,*::after{{box-sizing:border-box;margin:0;padding:0;}}
  ...
  .nav-btn:hover, .navbar-nav .nav-link:hover, .navbar-nav .nav-link.active{{color:var(--a1)!important;background:rgba(59,158,255,0.09);}}
...
<header class="site-header">
  <div class="header-inner">
    <a href="/" class="logo">
      <div class="logo-icon"><i class="fa-solid fa-microphone-lines" style="color:#fff;font-size:.82rem;"></i></div>
      Voice<span style="color:var(--a1);">Pro</span>
    </a>
    <nav class="nav-links">
      <a href="/" class="nav-link"><i class="fa-solid fa-house" style="margin-right:5px;"></i>Home</a>
      <a href="/blog.html" class="nav-link"><i class="fa-solid fa-newspaper" style="margin-right:5px;"></i>Blog</a>
      <a href="/about.html" class="nav-link">About</a>
      <a href="/contact.html" class="nav-link">Contact</a>
      <a href="/tts/" class="nav-link" style="color:var(--a1);font-weight:600;">🌐 All Languages</a>
      <button onclick="toggleTheme()" class="nav-link" id="theme-btn" style="background:none;border:none;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;padding:0;" aria-label="Toggle theme">
  ...
  <div id="mobile-menu" class="nav-mobile-menu">
    <a href="/" class="nav-link"><i class="fa-solid fa-house" style="margin-right:8px;"></i>Home Studio</a>
    <a href="/blog.html" class="nav-link"><i class="fa-solid fa-newspaper" style="margin-right:8px;"></i>Blog</a>
    <a href="/about.html" class="nav-link">About</a>
    <a href="/contact.html" class="nav-link">Contact</a>
    <a href="/privacy.html" class="nav-link">Privacy Policy</a>
    <a href="/tts/" class="nav-link" style="color:var(--a1);font-weight:700;">🌐 All 104 Languages</a>
    <button onclick="toggleTheme();toggleMobileMenu()" class="nav-link" id="theme-btn-mob" style="background:none;border:none;cursor:pointer;display:flex;align-items:center;gap:8px;padding:10px 14px;width:100%;box-sizing:border-box;">
...
<!-- HERO -->
<section style="padding:88px 20px 32px;max-width:1100px;margin:0 auto;text-align:center;">
  <div class="breadcrumb" style="margin-bottom:16px;">
    <a href="/">Home</a> &rsaquo; <a href="/tts/">All Languages</a> &rsaquo; <span style="color:var(--txt);">{flag} {lang_name} ({country})</span>
  </div>
  <div style="margin-bottom:14px;"><span style="font-size:2.8rem;">{flag}</span></div>
  <div class="badge-pill" style="margin-bottom:16px;">✦ FREE {lang_upper} TEXT TO SPEECH 2026 ✦</div>
  <h1 style="font-size:clamp(1.9rem,5vw,3.2rem);font-weight:800;margin-bottom:14px;">
    <span class="tg">Free {lang_name} Text to Speech</span><br>
    <span style="font-size:clamp(1rem,2.5vw,1.5rem);color:var(--txt2);font-weight:600;">{country} · Neural AI Voice Generator · No Login</span>
  </h1>
  <p style="color:var(--txt2);font-size:1rem;max-width:640px;margin:0 auto 24px;line-height:1.78;">
    Convert {lang_name} text to natural speech instantly. {voice_count}+ neural voices, MP3/WAV download,
    no login required. Best free {lang_name} TTS tool for {country} in 2026.
  </p>
...
<section style="max-width:860px;margin:0 auto 32px;padding:0 18px;">
  <div class="stats-grid" style="display:grid;grid-template-columns:repeat(4,1fr);gap:14px;">
    <div class="stat-card">
      <div style="font-size:1.5rem;margin-bottom:6px;">🎙️</div>
      <div style="font-family:'Syne',sans-serif;font-weight:800;font-size:1.4rem;color:var(--a1);">{voice_count}+</div>
      <div style="font-size:.74rem;color:var(--muted);font-weight:500;">{lang_name} Voices</div>
    </div>
    <div class="stat-card">
      <div style="font-size:1.5rem;margin-bottom:6px;">🌍</div>
      <div style="font-family:'Syne',sans-serif;font-weight:800;font-size:1.4rem;color:var(--a2);">104</div>
      <div style="font-size:.74rem;color:var(--muted);font-weight:500;">Languages</div>
    </div>
    <div class="stat-card">
      <div style="font-size:1.5rem;margin-bottom:6px;">⚡</div>
      <div style="font-family:'Syne',sans-serif;font-weight:800;font-size:1.4rem;color:var(--ok);">5K</div>
      <div style="font-size:.74rem;color:var(--muted);font-weight:500;">Chars / Request</div>
    </div>
    <div class="stat-card">
      <div style="font-size:1.5rem;margin-bottom:6px;">🆓</div>
      <div style="font-family:'Syne',sans-serif;font-weight:800;font-size:1.4rem;color:var(--a3);">100%</div>
      <div style="font-size:.74rem;color:var(--muted);font-weight:500;">Free Forever</div>
    </div>
  </div>
</section>
...
<section style="max-width:860px;margin:0 auto;padding:0 18px 56px;">
  <div class="glass" style="padding:30px;">
    <h2 style="font-size:1.2rem;font-weight:700;margin-bottom:18px;display:flex;align-items:center;gap:9px;">
    ...
    <div style="display:flex;gap:8px;margin-bottom:22px;background:var(--panel);border-radius:14px;padding:5px;border:1px solid var(--border);">
      ...
      <button class="tab-btn" id="tab-multi" onclick="switchTab('multi')">
    ...
    <div id="panel-single">
      ...
      <div class="controls-grid" style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:18px;">
        <div class="ctrl">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:9px;">
            ...
            <span id="badge-rate" style="font-size:.76rem;background:rgba(61,214,140,0.1);color:var(--ok);padding:2px 8px;border-radius:20px;font-family:'Space Mono',monospace;">1.0x</span>
          </div>
        ...
        <div class="ctrl">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:9px;">
            ...
            <span id="badge-pitch" style="font-size:.76rem;background:rgba(124,95,230,0.1);color:var(--a2);padding:2px 8px;border-radius:20px;font-family:'Space Mono',monospace;">+0</span>
          </div>
        ...
        <div class="ctrl">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:9px;">
            ...
            <span id="badge-vol" style="font-size:.76rem;background:rgba(59,158,255,0.1);color:var(--a1);padding:2px 8px;border-radius:20px;font-family:'Space Mono',monospace;">100%</span>
          </div>
      ...
      <div id="result-area" class="hidden">
          ...
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px;">
            <div style="display:flex;align-items:center;gap:10px;">
              ...
              <div>
                ...
                <div id="gen-info" style="font-size:.74rem;color:var(--muted);margin-top:1px;">Neural TTS · {lang_name}</div>
              </div>
            </div>
        ...
        <div style="display:flex;gap:10px;margin-bottom:10px;">
          <button onclick="doDownload('mp3')" style="flex:1;background:rgba(61,214,140,0.12);border:1px solid rgba(61,214,140,0.28);color:var(--ok);border-radius:12px;padding:12px;font-weight:700;cursor:pointer;font-family:'Syne',sans-serif;font-size:.85rem;"><i class="fa-solid fa-download" style="margin-right:6px;"></i>MP3</button>
          <button onclick="doDownload('wav')" style="flex:1;background:rgba(124,95,230,0.12);border:1px solid rgba(124,95,230,0.28);color:var(--a2);border-radius:12px;padding:12px;font-weight:700;cursor:pointer;font-family:'Syne',sans-serif;font-size:.85rem;"><i class="fa-solid fa-download" style="margin-right:6px;"></i>WAV</button>
          <button onclick="copyAudioLink()" style="flex:1;background:rgba(59,158,255,0.12);border:1px solid rgba(59,158,255,0.28);color:var(--a1);border-radius:12px;padding:12px;font-weight:700;cursor:pointer;font-family:'Syne',sans-serif;font-size:.85rem;"><i class="fa-solid fa-link" style="margin-right:6px;"></i>Copy</button>
        </div>
    ...
    <div id="panel-multi" class="hidden">
      <div style="background:rgba(59,158,255,0.05);border:1px solid rgba(59,158,255,0.15);border-radius:14px;padding:16px;margin-bottom:18px;font-size:.85rem;color:var(--txt2);">
        ...
        <strong>Multi-Voice Dialogue:</strong> Write lines starting with <code style="background:var(--panel);padding:2px 6px;border-radius:5px;">Speaker1:</code> and <code style="background:var(--panel);padding:2px 6px;border-radius:5px;">Speaker2:</code>. Each line will use a different voice.
      </div>
      <div style="margin-bottom:14px;">
        <span class="slbl">Dialogue Script</span>
        <textarea id="multi-txt" rows="8" placeholder="Speaker1: Hello! Welcome to VoicePro.&#10;Speaker2: Thank you! This is amazing.&#10;Speaker1: You can generate natural audio in {lang_name}!&#10;Speaker2: And download it as MP3 or WAV for free!"></textarea>
      </div>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:18px;">
        ...
        <div>
          <span class="slbl">Speaker 2 Voice</span>
          <select id="multi-voice2">
            <option value="male-1">👨 Male 1 – Deep</option>
            <option value="young-m1">👨‍🦰 Guy – Male Natural</option>
            <option value="female-1">👩 Female 1 – Natural</option>
            <option value="young-f1">👩‍🦰 Aria – Female Young</option>
            <option value="mid-m1">👨‍🦳 Steffan – Male Presenter</option>
          </select>
        </div>
      </div>
      <div style="margin-bottom:18px;display:grid;grid-template-columns:1fr 1fr;gap:12px;">
        <div>
          <span class="slbl">Language</span>
          <select id="multi-lang" onchange="redirectToLang(this.value)">
            {all_languages_options}
          </select>
        </div>
        <div>
      ...
      <div id="multi-result" class="hidden" style="margin-top:20px;border-top:1px solid var(--border);padding-top:20px;">
        <div style="font-weight:700;color:var(--ok);margin-bottom:12px;font-family:'Syne',sans-serif;"><i class="fa-solid fa-square-check" style="margin-right:6px;"></i>Dialogue Audio Ready!</div>
        <div id="multi-lines-output"></div>
      </div>
    </div>
  </div>
</section>
...
<section style="max-width:1100px;margin:0 auto;padding:0 18px 56px;">
  <h2 style="font-size:clamp(1.4rem,3vw,2rem);font-weight:800;margin-bottom:8px;text-align:center;">Who Uses <span class="tg">{lang_name} TTS</span>?</h2>
  ...
  <div style="text-align:center;">{use_case_tags}</div>
</section>

<!-- FEATURES -->
<section style="max-width:1100px;margin:0 auto;padding:0 18px 56px;">
  <h2 style="font-size:clamp(1.4rem,3vw,2rem);font-weight:800;margin-bottom:28px;text-align:center;">Why VoicePro for <span class="tg">{lang_name}</span>?</h2>
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:18px;">
    <div class="feature-card"><div style="font-size:1.9rem;margin-bottom:14px;">🧠</div><h3 style="font-family:'Syne',sans-serif;font-weight:700;margin-bottom:8px;">{lang_name}-Native Neural Voices</h3><p style="color:var(--txt2);font-size:.88rem;line-height:1.78;">Voices trained specifically on {lang_name} ({country}) native speaker data. Correct pronunciation, natural intonation, and authentic regional accent.</p></div>
    <div class="feature-card"><div style="font-size:1.9rem;margin-bottom:14px;">⚡</div><h3 style="font-family:'Syne',sans-serif;font-weight:700;margin-bottom:8px;">Instant MP3 / WAV Download</h3><p style="color:var(--txt2);font-size:.88rem;line-height:1.78;">No queues, no waiting. Generate up to 5,000 characters in seconds. Download MP3 for web or WAV for studio quality.</p></div>
    <div class="feature-card"><div style="font-size:1.9rem;margin-bottom:14px;">🎛️</div><h3 style="font-family:'Syne',sans-serif;font-weight:700;margin-bottom:8px;">Full Voice Control</h3><p style="color:var(--txt2);font-size:.88rem;line-height:1.78;">Adjust speed (0.5x–2x), pitch (−10 to +10), volume, and speaking style. 100+ voice characters — fully customizable.</p></div>
    <div class="feature-card"><div style="font-size:1.9rem;margin-bottom:14px;">👥</div><h3 style="font-family:'Syne',sans-serif;font-weight:700;margin-bottom:8px;">Multi-Voice Dialogue</h3><p style="color:var(--txt2);font-size:.88rem;line-height:1.78;">Create {lang_name} conversations with 2 different voices. Perfect for podcasts, YouTube videos, educational content, and audiobooks.</p></div>
    <div class="feature-card"><div style="font-size:1.9rem;margin-bottom:14px;">🔒</div><h3 style="font-family:'Syne',sans-serif;font-weight:700;margin-bottom:8px;">No Login, No Tracking</h3><p style="color:var(--txt2);font-size:.88rem;line-height:1.78;">No account required. Your {lang_name} text is processed on-demand and never stored, sold, or shared. 100% private.</p></div>
    <div class="feature-card"><div style="font-size:1.9rem;margin-bottom:14px;">📱</div><h3 style="font-family:'Syne',sans-serif;font-weight:700;margin-bottom:8px;">Works on Any Device</h3><p style="color:var(--txt2);font-size:.88rem;line-height:1.78;">Fully responsive on mobile, tablet, and desktop. No app download needed — works on iOS, Android, and PC.</p></div>
  </div>
</section>

<!-- FAQ -->
<section style="max-width:780px;margin:0 auto;padding:0 18px 64px;">
  <h2 style="font-size:clamp(1.4rem,3vw,2rem);font-weight:800;margin-bottom:8px;text-align:center;">Frequently Asked <span class="tg">Questions</span></h2>
...
<section style="max-width:1100px;margin:0 auto;padding:0 18px 64px;">
  <h2 style="font-size:1.3rem;font-weight:800;margin-bottom:16px;text-align:center;">Explore Other <span class="tg">Languages</span></h2>
  <div style="text-align:center;max-width:900px;margin:0 auto;">{related_links}</div>
</section>
...
<footer class="pro-footer">
  <div style="max-width:1100px;margin:0 auto;display:grid;grid-template-columns:2fr 1fr 1fr;gap:40px;padding-bottom:44px;border-bottom:1px solid var(--border);">
    <div>
      ...
      <p style="color:var(--muted);font-size:.875rem;line-height:1.75;">Free {lang_name} Text-to-Speech. 104 languages, 100+ neural voices, instant MP3 download. No login — ever.</p>
    </div>
    <div>
...
<script>
  ...
  async function doGenerate() {{
    ...
    fd.append('text', text); fd.append('language', LANG_CODE);
    ...
    try {{
      ...
      if (d.success) {{
        ...
        if (genInfo) genInfo.textContent = (d.method || 'Neural TTS') + ' · ' + voiceName + ' · ' + LANG_NAME;
        let badge = 'Natural';
        if (selVal.includes('kid')) badge = '👧 Kid';
        else if (selVal.includes('teen')) badge = '🧑 Teen';
        else if (selVal.includes('young-f') || selVal.includes('young-m')) badge = '⭐ Young Adult';
  ...
  async function doMultiGenerate() {{
    const script = document.getElementById('multi-txt').value.trim();
    if (!script) {{ showToast('Please enter dialogue script!', 'err'); return; }}
    const lines = script.split('\\n').filter(l => l.trim());
    const btn = document.getElementById('multi-gen-btn'), lbl = document.getElementById('multi-gen-lbl');
    btn.disabled = true;
    lbl.innerHTML = '<span class="spinner"></span><span style="margin-left:9px;">Generating dialogue…</span>';
    const voice1 = document.getElementById('multi-voice1').value;
    const voice2 = document.getElementById('multi-voice2').value;
    const fmt = document.getElementById('multi-fmt').value;
    const outputDiv = document.getElementById('multi-lines-output');
    outputDiv.innerHTML = ''; document.getElementById('multi-result').classList.add('hidden');
    let successCount = 0;
    for (let i = 0; i < lines.length; i++) {{
      const line = lines[i];
      const isSpeaker2 = line.toLowerCase().startsWith('speaker2:');
      const text = line.replace(/^speaker[12]:/i, '').trim();
      if (!text) continue;
      const voice = isSpeaker2 ? voice2 : voice1;
      const speakerLabel = isSpeaker2 ? 'Speaker 2' : 'Speaker 1';
      const color = isSpeaker2 ? 'var(--a2)' : 'var(--a1)';
      try {{
        const fd = new FormData();
        fd.append('text', text); fd.append('language', LANG_CODE);
        fd.append('voice_type', voice); fd.append('rate', '1.0');
        fd.append('pitch', '0'); fd.append('volume', '100');
        fd.append('style', 'general'); fd.append('format', fmt);
        fd.append('response_type', 'base64');
        const r = await fetch('/generate', {{ method: 'POST', body: fd }});
        const d = await r.json();
        if (d.success) {{
          ...
          lineDiv.style.cssText = 'margin-bottom:16px;padding:14px;background:var(--panel);border:1px solid var(--border);border-radius:12px;border-left:3px solid ' + color + ';';
          lineDiv.innerHTML = '<div style="font-size:.76rem;font-weight:700;color:' + color + ';margin-bottom:6px;font-family:Syne,sans-serif;">' + speakerLabel + '</div><div style="font-size:.9rem;color:var(--txt2);margin-bottom:10px;">' + text + '</div><audio src="' + d.audio_data + '" controls style="width:100%;height:36px;"></audio>';
    ...
    if (successCount > 0) {{
      ...
      showToast('Dialogue generated! ' + successCount + ' lines ready 🎙️');
